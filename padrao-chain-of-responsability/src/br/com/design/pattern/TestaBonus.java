...
public class TestaBonus {
    ...
    public static void main(String[] args) {
        ...
        BigDecimal bonusF1 = new CalculadoraPorAnos(new CalculadoraPorSalario(new SemBonus())).calcular(f1);
        BigDecimal bonusF2 = new CalculadoraPorAnos(new CalculadoraPorSalario(new SemBonus())).calcular(f2);
